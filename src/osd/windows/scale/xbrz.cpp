...
inline
xbrz_uint32 alphaBlend2(xbrz_uint32 pix1, xbrz_uint32 pix2, double alpha)
{
...
inline
void fillBlock(xbrz_uint32* trg, int pitch, xbrz_uint32 col, int blockWidth, int blockHeight)
{
...
inline
void fillBlock(xbrz_uint32* trg, int pitch, xbrz_uint32 col, int n) { fillBlock(trg, pitch, col, n, n); }
...
inline
void rgbtoLab(xbrz_uint32 c, unsigned char& L, signed char& A, signed char& B)
{
...
inline
double distLAB(xbrz_uint32 pix1, xbrz_uint32 pix2)
{
...
inline
double distRGB(xbrz_uint32 pix1, xbrz_uint32 pix2)
{
...
inline
double distNonLinearRGB(xbrz_uint32 pix1, xbrz_uint32 pix2)
{
...
inline
double distYCbCr(xbrz_uint32 pix1, xbrz_uint32 pix2, double lumaWeight)
{
...
inline
double distYUV(xbrz_uint32 pix1, xbrz_uint32 pix2, double luminanceWeight)
{
...
inline
double colorDist(xbrz_uint32 pix1, xbrz_uint32 pix2, double luminanceWeight)
{
...
inline
bool equalColor(xbrz_uint32 col1, xbrz_uint32 col2, double luminanceWeight, double equalColorTolerance)
{
